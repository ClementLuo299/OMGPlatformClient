...
public class TicTacToeController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            UserAccount account1 = new UserAccount("Player 1", "temp_pass1");
            UserAccount account2 = new UserAccount("Player 2", "temp_pass2");
            
            // Create Player objects with the UserAccount objects
            player1 = new TicTacToePlayer(account1, "X");
            player2 = new TicTacToePlayer(account2, "O");
